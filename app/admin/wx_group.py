...
from app.models.wx_group import WxGroup
from app.models.base import db

api = Redprint('wx_group')
mdb = globals()['WxGroup']
...
def wx_group_index():
    all = mdb.all()
    count = mdb.count()
    return render_template('admin/wx_group/index.html', list=all, count=count, menutitle='微信群管理', navtitle='微信群列表')
...
def wx_group_add():
    if request.method == 'POST':
        ...
        return render_template('admin/wx_group/add.html')
...
def wx_group_edit():
    if request.method == 'GET':
        ...
        return render_template('admin/wx_group/edit.html', find=find)
